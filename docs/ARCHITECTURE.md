...
| Validation service | **LANDED for M1-core (spec 005).** Pure evaluators in `Evo.Domain/Scheduling`: `RouteValidator` (V3 geo-scope, V5 revenue, V6 SERVICE-mix cap, V7 time-window/ban), `OverlapValidator` (V12), plus V1/V2 from `DayScheduler` and V9 (mandatory patch expiry) enforced at the patch-create endpoint. Deferred: V8, V10/V11 (task/rule engine, M2), V13/V15 (travel/OSRM), V14 (leave/Onarım, M4), V16. | `Evo.Domain/Scheduling` (pure) |
